                                ...
                                <div className="share--url p-3">
                                    <div className="row ">
                                        <div className="col-12 alert-success p-4">
                                            ...
                                            <a className="text-black share--url" target="_blank" href={`/resources/google-ads-preview-tool?id=${responseID}`}>{window.location.hostname}/resources/google-ads-preview-tool?id={responseID}</a>
                                        </div>
                                    </div>
                                </div>
                            }
